...
Demonstrates how to use the autoblogged_post action to display all the post variables of each post which can be useful for debugging issues with some feeds. 
