=== AutoBlogged Full Content Addon ===
Requires at least: 2.8
Tested up to: 3.1

Retrieves full article content when RSS feeds only provide excerpts. 

== Description ==

This plugin uses boilerpipe-web.appspot.com and viewtext.org to turn RSS feeds with excerpts into full content feeds. 
